          ...
          <Card>
            ...
            <form className='d-flex justify-content-end' onSubmit={(e)=>{
              ...
              <div className='d-flex align-items-center'>
               <Input placeholder='axtar...' className='h-25' onKeyDown={searchCategory} />
               <Button className='btn'style={{margin:" 19px 0px -21px"}} type='submit'color='primary'><img src={require('../../assets/images/icons/search.svg')} alt=''/></Button>
              </div>
              </form>
              <MDBDataTable
                   className=''
